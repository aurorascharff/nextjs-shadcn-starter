...
function FormExample() {
  ...
  return (
    <Showcase title="TabList with Form">
      <TabList tabs={formTabs} activeTab={activeTab} changeAction={handleTabChangeAction}>
...
type PreferencesContentProps = {
  ...
  setNotifications: React.Dispatch<React.SetStateAction<{ email: boolean; push: boolean; sms: boolean }>>;
  theme: string;
  setTheme: React.Dispatch<React.SetStateAction<string>>;
};

function PreferencesContent({ notifications, setNotifications, theme, setTheme }: PreferencesContentProps) {
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
      ...
      <CardContent>
        <p className="text-muted-foreground text-sm">
          Configure your notification and theme preferences using the dropdown menu above.
        </p>
      </CardContent>
    </Card>
  );
